  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <section>
        ...
        <p>
          Bienvenue sur le site de notre association. En accédant à ce site,
      ...
      <section>
        ...
        <p>
          Le contenu de ce site est fourni à titre informatif uniquement. Vous
          vous engagez à utiliser le site de manière légale et appropriée.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          protégés par les lois relatives à la propriété intellectuelle et sont
          la propriété exclusive de l'association.
        </p>
      </section>
      <section>
        <h2>4. Responsabilité</h2>
        <p>
          L'association ne saurait être tenue responsable des dommages directs
      ...
      <section>
        ...
        <p>
          L'association se réserve le droit de modifier les présentes conditions
          générales à tout moment. Les modifications prendront effet dès leur
      ...
      <section>
        ...
        <p>
          ...
          site, vous vous connectez à votre compte, faites un don, ou participez
          à une enquête. Les informations collectées incluent votre nom, adresse
          e-mail, numéro de téléphone et/ou carte de crédit.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          ...
          consentement, en dehors de ce qui est nécessaire pour répondre à une
          demande et/ou une transaction, comme par exemple expédier une
          commande.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          service client) ont accès aux informations personnelles identifiables.
        </p>
      </section>
      <section>
